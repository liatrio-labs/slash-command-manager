...
def generate(  # noqa: PLR0913 PLR0912 PLR0915
    ...
    if prompts_dir is not None and any(
        [github_repo is not None, github_branch is not None, github_path is not None]
    ):
        print(
        ...
        print("\nTo fix this:", file=sys.stderr)
        print("  - Use either --prompts-dir for local prompts, or", file=sys.stderr)
        print(
